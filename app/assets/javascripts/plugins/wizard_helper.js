...
;(function ( $, window, document, undefined ) {
    ...
    var wizard_template = "<div class='grid--full wizard-helper'><div class='grid__item two-twelfths text--center'><i data-toggle='popover' data-content=\"{{{ content }}}\" data-html='true' data-placement='left' class='cursor-help fa fa-lightbulb-o blue wizard__icon'></i></div><div class='grid__item ten-twelfths wizard-helper__content text--muted'>{{{ content }}}</div></div>";
    Plugin.prototype = {

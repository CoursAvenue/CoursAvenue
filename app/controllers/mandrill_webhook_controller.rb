  ...
  def create
    ...
    events.each do |event|
      ...
      if user.nil?
        ...
        sleeping_structure.other_emails = sleeping_structure.other_emails.split(';').delete(event['msg']['email']).join(',') if sleeping_structure and sleeping_structure.other_emails
      end
      next if user.nil?

...
class Pro::SubscriptionPlansController < Pro::ProController
  ...
  #
  #   stats = { impressions:        client.impression_count(@subscription.structure.id, since_date),
  #             views:              client.view_count(@subscription.structure.id, since_date),
  #             actions:            client.action_count(@subscription.structure.id, since_date),
  #             telephone:          client.telephone_count(@subscription.structure.id, since_date),
  #             website:            client.website_count(@subscription.structure.id, since_date),
  ...
  #
  #             impressions_full:   client.impression_count(@subscription.structure.id, 10.years.ago),
  #             views_full:         client.view_count(@subscription.structure.id, 10.years.ago),
  #             actions_full:       client.action_count(@subscription.structure.id, 10.years.ago),
  #             telephone_full:     client.telephone_count(@subscription.structure.id, 10.years.ago),
  #             website_full:       client.website_count(@subscription.structure.id, 10.years.ago),
  ...
  def index_color(stats, action = :actions, conversations = :conversations)
    Analytic::Client.score(stats[action], stats[conversations])
  end

class Mailboxer::Label < ActiveHash::Base
  ...
  self.data = [
    ...
    { id: 4, short_name: 'Request',         name: 'mailboxer.label.request',         color: 'blue-green' },
    { id: 5, short_name: 'public_question', name: 'mailboxer.label.public_question', color: 'purple'     }
  ]

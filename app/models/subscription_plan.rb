    ...
    workbook.add_worksheet(name: 'Suivi Premium') do |sheet|
      ...
      subscriptions.each do |subscription|
        ...
        sheet.add_row [
          ...
          subscription.facebook_active.present? ? subscription.facebook_active.to_s : 'false',
          subscription.adwords_active.present? ? subscription.adwords_active.to_s : 'false',

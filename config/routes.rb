  ...
  constraints subdomain: (Rails.env.staging? ? 'pro.staging' : 'pro') do
    namespace :pro, path: '' do
      ...
      devise_for :admins, controllers: {
        omniauth_callbacks: 'pro/admins/omniauth_callbacks',
        sessions: 'pro/admins/sessions',
        registrations: 'pro/admins/registrations',
        passwords: 'pro/admins/passwords',
        confirmations: 'pro/admins/confirmations'
      }, path: '/', path_names: {
        sign_in: '/connexion',
        sign_out: 'logout',
        registration: 'rejoindre-coursavenue-pro',
        sign_up: '/',

...
rake "import:subjects[Export/Discipline.csv]"
...
# heroku run rake "import:subjects[Export/Discipline.csv]"
# heroku run rake import:clean && heroku run rake "import:structures[Export/Structure.csv]" && heroku run rake "import:courses_prices_and_plannings[Export/Planning-Cours.csv]" && heroku run rake "import:subjects[Export/Discipline.csv]"

...
will not assume anything about the relationship between view and model.
    ...
    class_option :'stand-alone', :desc => "Do not create a namespace for the view. e.g. generating Widget will not create ./widget/widget.js"
    ...
    def create_item_view
        ...
        create_file(app_path(name) + 'views' + namespace_path(namespace) + manifest, "#{manifest_require} ./#{item_view_name(name).underscore}\n")
    end
